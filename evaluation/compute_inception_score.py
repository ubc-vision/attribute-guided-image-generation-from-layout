...
parser.add_argument('--input_image_dir',
                    default='~/checkpoints/all/results/final128_128_est_change_att_vg_bs12e64z64clstm3li1.0lo1.0lc1.0lz8.0lc1.0lk0.01')
# global:'/scratch/markma/checkpoints/high_res/results/global_layout2im_high_res_3dis_coco_bs8e64z64clstm3li1.0lo1.0lc1.0lz10.0lc1.0lk0.01/'
# real: '/scratch/markma/checkpoints/high_res/results/real_global_layout2im_high_res_3dis_coco_bs8e64z64clstm3li1.0lo1.0lc1.0lz10.0lc1.0lk0.01'
...
def load_images(args, image_dir):
    ...
    for fn in os.listdir(image_dir):
        ...
        if args.image_size is not None:
            img = np.array(PIL.Image.fromarray(img).resize((args.image_size, args.image_size)))
        images.append(img)
